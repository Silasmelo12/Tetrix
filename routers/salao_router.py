...
from schemas.salao import SalaoResponse, SalaoCreate
...
@router.post("/saloes", response_model=SalaoResponse)
...
# READ (LIST)
@router.get("/saloes", response_model=list[SalaoResponse])
...
# UPDATE
@router.put("/saloes/{salao_id}", response_model=SalaoResponse)
